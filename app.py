...
st.markdown(
    ...
    📘 Fórmula utilizada: <b>(M1 + (M2 × 2)) / 3</b><br>
    🎯 Média mínima considerada: <b>5</b>
    </p>
    """,
    unsafe_allow_html=True
)
...
if st.button("Calcular Média"):
    ...
    # Mostrar quanto precisa para passar no semestre
    ...
    # Informação sobre o cálculo e contexto
st.markdown(
    """
    <p style='text-align: center; color: #555;'>
    📘 Fórmula utilizada: <b>(M1 + (M2 × 2)) / 3</b><br>
    🎯 Média mínima considerada: <b>5</b><br><br>
    ✨ Este projeto usa a média da <b>Universidade de Mogi das Cruzes</b>.<br>
    Feito por uma aluna para outros alunos da universidade!
    </p>
    """,
    unsafe_allow_html=True
)